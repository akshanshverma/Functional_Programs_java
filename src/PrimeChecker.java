...
public class PrimeChecker {
	...
	/*
	 * JAVA STYLE GUIDE - CLASS STATIC VARIABLE DECLARATION STYLE NOTES - ALL STATIC
	 * VARIABLE SHOULD BE DECLARED IN THE TOP. FOR EVERY STATIC VARIABLE THERE NEEDS
	 * TO COMMENT - STATIC VARIABLE ARE DECLARED AS ALL CAPS SEPERATED BY _ IF
	 * MULTIPPLE WORD
	 */
	...
	/*
	 * Static Variable is declared to Print message if the number is not Prime
	 * Number
	 */
	public static String NOT_PRIME_NUMBER_MESSAGE = " is not a prime number";

	/*
	 * JAVA STYLE GUIDE - CLASS INSTANCE VARIABLE DECLARATION STYLE NOTES - ALL
	 * CLASS VARIABLE SHOULD BE DECLARED IN THE TOP AFTER STATIC DICLARATION IF ANY.
	 * - CLASS MEMBER VARIABLE NAME STARTS WITH 'm' TO INDICATE CLASS VARIABLE.
	 * FOLLOWWED BY THE VARIABLE NAME IN CAMLE CASE - FOR EVERY CLASS VARIABLE THERE
	 * NEEDS TO BE A COMMENT DESRIBING THE NEED FOR THE VARIABLE
	 */
	...
	/*
	 * JAVA STYLE GUIDE - DEFAULT CONSTRUCTOR DECLARATION STYLE NOTES - DEFAULT
	 * CONSTRUCTOR IS IMMEDIATELY AFTER CLASS VARIABLES AND BEFOR ANY OTHER
	 * CONSTRUCTOR OR FUNCTION DECLARATION - FOR EVERY CONSTRUCTOR THERE NEEDS TO BE
	 * A COMMENT DESRIBING THE NEED
	 */
	...
	/*
	 * JAVA STYLE GUIDE - CLASS FUNCTION DECLARATION STYLE NOTES - CLASS FUNCTION IS
	 * DECLARED IMMEDIATELY AFTER CONSTRUCTOR - FOR EVERY FUNCTION THERE NEEDS TO BE
	 * A COMMENT DESRIBING THE PURPOSE - FUNCTION DECLARATION STARTS WITH A SMALL
	 * CASE AND THEN CAMEL CASE FOR EVERY WORD IN THE FUNCTION
	 */
	...
	/**
	 * return a string message describing the number is prime or not. This function
	 * overrides the toString function declared in the Object Class
	 *
	...
	public String toString() {
		...
		if (mIsPrime)
			message = mInputNumber + PRIME_NUMBER_MESSAGE;
		else
			message = mInputNumber + NOT_PRIME_NUMBER_MESSAGE;
		return message;
	}

	/**
	 * Static Function to check for prime. This function is declared static because
	 * no initialization of clase PrimeChecker is needed if the number is to be
	 * checked for prime.
	 *
	 * @param number the number to check for prime
	...
	public static boolean checkPrime(long n) {
		...
		/*
		 * JAVA STYLE GUIDE - EVERY BLOCK NEEDS TO HAVE THE COMMENT NOTES - LEAVE SINGLE
		 * BLANK LINE AFTER EVERY LOOP - NO NEED FOR CURLY BRACES {} IF THE CONDITION
	...
	public static void main(String[] args) {
		...
		// Only taking valid integer input. If Exception is thrown than not procssing
		// further.
		try {
		...
		if (isPrime)
			System.out.println(n + PrimeChecker.PRIME_NUMBER_MESSAGE);
		else
			System.out.println(n + PrimeChecker.NOT_PRIME_NUMBER_MESSAGE);
